...
import GeneralRequestCard, {
  GeneralRequest,
} from "./userRequestComponent/generalRequestCard";
...
function RequestsPage() {
  ...
  const getCategories = async () => {
    ...
    try {
      const response = await fetch(
        "http://127.0.0.1:5000/get_filter_categories",
        {
          credentials: "include",
          method: "GET",
          headers: {
  ...
  const getLocations = async () => {
    try {
      const response = await fetch(
        "http://127.0.0.1:5000/get_filter_locations",
        {
          credentials: "include",
          method: "GET",
          headers: {
  ...
  return (
    <div className="my-32">
      ...
      <div className="mx-20 text-center">
        ...
        <button
          onClick={openModal}
          className="flex justify-center items-center mb-3 rounded-md bg-clear px-3 py-1.5 text-sm font-semibold leading-6 text-blue-900 shadow-sm outline outline-2 outline-blue-900 hover:bg-gray-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-900"
        >
          {" "}
          Filter{" "}
        </button>
